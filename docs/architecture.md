# Arquitectura actual de MUGA Books
...
- Una capa de persistencia aislada para poder cambiar SQLite por libSQL o D1 si
  el despliegue futuro lo requiere.
...
- Hostinger SMTP concentra el envío de notificaciones de email.
